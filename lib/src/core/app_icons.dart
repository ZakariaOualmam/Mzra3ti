...
class AppIcons {
  ...
  static const IconData farms = Icons.landscape; // field / mountain
  static const IconData weather = Icons.cloud; // cloud (or use wb_sunny for sun)
  static const IconData sun = Icons.wb_sunny;
  static const IconData add = Icons.add_circle;
  static const IconData share = Icons.share;
  static const IconData report = Icons.history;
